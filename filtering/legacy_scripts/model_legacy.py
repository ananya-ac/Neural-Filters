...
class ModularNeuralODEFilter(pl.LightningModule):
    ...
    adjoint=True   when adaptive_steps=True, backprop instead uses
                ...
                docstring — model_legacy.py didn't support this at all
                until now).
    ...
    uncertainty_rnn_lstm=True  — uncertainty_rnn is an
                ...
                no_control_eval_legacy.py) -- internally it packs [h ‖ c]
    ...
    def on_after_backward(self):
        ...
        # train_legacy.py) runs. clip_grad_norm_ both returns this pre-clip
